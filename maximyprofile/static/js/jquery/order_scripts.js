...
//    console.log(total_forms)
    ...
    let order_total_quantity = parseInt($('.order_total_quantity').text()) || 0; // Количество товара
    let order_total_cost = parseInt($('.order_total_cost').text().replace(',', '.')) || 0; // Стоимость заказа
//    console.log(order_total_quantity)
//    console.log(order_total_cost)

// считываем количество каждого продукта и его цену в массивы
    ...
    $('.order_form').on('click','input[type=number]',function(){
        ...
        if(price_arr[orderitem_num]){
            ...
            orderSummaryUpdate(price_arr[orderitem_num],delta_quantity,orderitem_num,quantity_arr[orderitem_num])
        }
...
// 2 метод
    ...
    function orderSummaryUpdate(orderitem_price,delta_quantity,orderitem_num,order_item_quantity){
